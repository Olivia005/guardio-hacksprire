      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 relative w-full flex justify-end">
        <div className="flex flex-1 lg:min-h-[900px]">
          <Image
            ...
            width={440}
            height={1000}
            className="absolute pl-5 top-[13%] z-10 hidden max-w-[1500px] rotate-[15deg] md:-left-16 lg:flex mx-10"
          />
        </div>
        ...
        <div className="z-20 flex w-full flex-col lg:w-[60%]">
          <div className='relative'>
            ...
            />
            <h2 className="font-bold text-5xl lg:bold-64">Our Features</h2>
          </div>
